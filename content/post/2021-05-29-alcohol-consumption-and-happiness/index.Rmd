...
dt_clear %>%
  ...
  kable(., digits = 2, align = "l", col.names = c("Country", "Region", "Happiness Rank", "Happiness Score", "Beer servings", "Spirit servings", "Wine servings", "Total liters of pure alcohol"), caption = "Ten happiest countries")
...
dt_clear %>%
  ...
  top_n(5) %>%
  kable(., digits = 2, align = "l", col.names = c("Country", "Region", "Happiness Rank", "Happiness Score", "Beer servings", "Spirit servings", "Wine servings", "Total liters of pure alcohol"), caption = "Top ten countries that drinks the most alcohol")
...
dt_clear %>%
  ...
  kable(., digits = 2, align = "l", col.names = c("Region", "mean happiness", "happiness standard deviation", "max happiness score", "minimum happiness score", "mean total liters of alcohol", "standard deviation of total liters of alcohol", "maximum total liters of alcohol", "minimum total liters of alcohol"))
...
plot_1 %>%
  ...
  labs(title = "Happiness levels by regions",
       x = "Regions", y = "mean happiness score") +
  theme_classic() +
...
plot_1 %>%
  ...
  labs(title = "Alcohol consumption by regions",
       x = "Regions", y = "mean total liters of alcohol") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90))
